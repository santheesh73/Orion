    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <m.div 
          ...
          className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(94,106,210,0.15),transparent_50%)]" 
        />
        <m.div 
          animate={{ 
            scale: [1, 1.2, 1],
          ...
          className="absolute inset-0 bg-[radial-gradient(circle_at_80%_80%,rgba(67,215,138,0.1),transparent_40%)]" 
        />
          ...
          {!isActiveDownload ? (
            ...
            >
              ...
              >
                ...
                >
                  <Sparkles className="size-8 text-primary drop-shadow-[0_0_10px_rgba(var(--primary),0.5)]" />
                </m.div>
              </m.div>
              
              <m.h1 variants={itemVariants} className="text-4xl font-semibold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
                Welcome to Orion
              </m.h1>
              
              <m.div variants={itemVariants} className="mx-auto mt-6 flex max-w-lg flex-col gap-2 text-lg text-muted-foreground sm:text-xl">
                <p>Private AI.</p>
                <p>Zero Cloud.</p>
                <p>Infinite Possibilities.</p>
              </m.div>
              
              <m.p variants={itemVariants} className="mx-auto mt-8 max-w-md text-sm text-muted-foreground/80">
                Everything happens on your device. Choose your AI model and begin.
              </m.p>

              <m.div variants={itemVariants} className="mt-16 text-left">
                <m.div 
                  whileHover={{ scale: 1.02, y: -2 }}
                  transition={{ type: "spring", stiffness: 400, damping: 30 }}
                  className="group relative overflow-hidden rounded-2xl border border-border/50 bg-surface/50 p-6 shadow-floating-panel backdrop-blur-xl transition-colors hover:border-primary/40 hover:bg-surface/80"
                >
                  ...
                  <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-primary border border-primary/20 shadow-[0_0_10px_rgba(var(--primary),0.1)]">
                          Recommended
                        </span>
                      </div>
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                      {!isDownloaded && (
                        <Button
                          size="lg"
                          variant="outline"
                          className="rounded-xl bg-background/50 backdrop-blur-sm hover:bg-background/80 transition-all active:scale-95"
                      ...
                      <Button 
                        size="lg" 
                        className="group/btn relative overflow-hidden rounded-xl bg-foreground text-background transition-all hover:bg-foreground/90 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] active:scale-95"
              ...
              <div className="flex flex-col items-center text-center">
                <div className="relative mb-8 flex size-20 items-center justify-center">
                  <svg className="absolute inset-0 size-full -rotate-90 transform" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="46" fill="none" stroke="currentColor" strokeWidth="4" className="text-muted/20" />
                    <m.circle 
                      cx="50" 
                      cy="50" 
                      r="46" 
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <m.span 
                      key={Math.round((download.progress || 0) * 100)}
